...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Al ingresar en "%1$s" (de aquí en adelante "nosotros", "nos", "nuestro", "%1$s", "%2$s"), <strong>acuerdas</strong> estar legalmente sometido a los siguientes términos. En caso contrario por favor no te registres y/o uses "%1$s". Podemos cambiar estos términos en cualquier momento e intentaríamos avisarte, sin embargo sería prudente que los revisaras por tu cuenta periódicamente. Seguir registrado a "%1$s" después de esos cambios significa que <strong>acuerdas</strong> estar legalmente sometido a esos nuevos términos tal como fueron actualizados y/o reformados.<br />
	<br />
	Nuestros foros están desarrollados por phpBB (de aquí en adelante "ellos", "sus", "software phpBB", "www.phpbb.com", "phpBB Group", "phpBB Teams") el cual es una solución de tablón de anuncios liberada bajo la "<a href="http://opensource.org/licenses/gpl-license.php">Licencia Pública General (General Public License en inglés)</a>" (de aquí en adelante "GPL") y puede ser descargada de <a href="https://www.phpbb.com/">www.phpbb.com</a>. El software phpBB solamente facilita discusiones basadas en Internet y la GPL estrictamente los excluye de lo que aprobamos y/o desaprobamos como conductas y/o contenido permisible. Para más información sobre phpBB, por favor visita: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'Tu cuenta ha sido actualizada. Sin embargo este foro requiere reactivación de cuenta por email. Una clave de activación ha sido enviada a la nueva dirección de email que has proporcionado. Por favor, comprueba tu email para más información.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Tu cuenta ha sido actualizada. Sin embargo este foro requiere reactivación de cuenta por los administradores via email. Un email se ha enviado a ellos y se te informará cuándo será reactivada tu cuenta.',
	'ACCOUNT_INACTIVE'				=> 'Tu cuenta ha sido creada. Sin embargo, este foro requiere activación de cuenta, una contraseña de activación ha sido enviada a la dirección de email que introdujiste. Por favor revisa tu email para más información',
	...
	'AVATAR_NOT_ALLOWED'			=> 'Tu avatar no puede ser mostrado porque los avatars han sido deshabilitados.',
	'AVATAR_PAGE'					=> 'Página',
	'AVATAR_TYPE_NOT_ALLOWED'		=> 'Tu avatar no puede ser mostrado porque su tipo de archivo ha sido deshabilitado.',
	...
	'BOOKMARKS'						=> 'Favoritos',
	'BOOKMARKS_EXPLAIN'				=> 'Puedes añadir temas a Favoritos para futuras consultas. Selecciona el checkbox para el Favorito que quieras borrar, luego haz clic sobre el botón <em>Eliminar Favoritos marcados</em>.',
	'BOOKMARKS_DISABLED'			=> 'Añadir a Favoritos está deshabilitado en este Foro',
	...
	'CLICK_GOTO_FOLDER'			    => '%1$sIr a tu carpeta “%3$s” %2$s',
	...
	'CONFIRM_EXPLAIN'				=> 'Para prevenir registros automáticos el administrador del Foro requiere que introduzcas un código de confirmación. El código se muestra en la imagen que deberías ver debajo. Si estás visualmente impedido o no puedes ver el código, por favor contacta al %sAdministrador del Foro%s.',
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Tenes que introducir tu contraseña actual si querés modificar tu dirección de correo electrónico o nombre de usuario.',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Para cambiar tu contraseña, tu dirección de correo electrónico o tu nombre de usuario, tenes que introducir tu contraseña actual',
	...
	'DELETE_COOKIES_CONFIRM'		=> '¿Estás seguro de querer borrar todas las cookies de este Foro?',
	...
	'FORCE_PASSWORD_EXPLAIN'		=> 'Antes de continuar navegando por el Foro se requiere que cambies tu contraseña',
	...
	'LINK_REMOTE_SIZE_EXPLAIN'		=> 'Especifica el ancho y el alto del avatar, déjalo en blanco para intentar una verificación automática.',
	...
	'LOGOUT_FAILED'					=> 'No has sido desconectado, la petición no coincide con tu sesión. Por favor contacta al administrador del foro si continúas experimentando problemas.',
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'Este mensaje fue borrado por su autor',
	'MESSAGE_SENT_ON'				=> 'en',
	...
	'MOVE_UP'						=> 'Subir',
	'NEW_EMAIL_CONFIRM_EMPTY'		=> 'No has introducido la confirmación de la dirección de correo.',	
	...
	'NOTIFY_METHOD_EXPLAIN'			=> 'Método para enviar mensajes empleado por este Foro.',
	...
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Las contraseñas deben tener entre %1$d y %2$d caracteres de longitud y contener mayúsculas y minúsculas',
	...
	'PM_DISABLED'			=> 'Los mensajes privados han sido deshabilitados en este Foro',
	'PM_FROM'				=> 'De',
	...
	'PM_TO'					=> 'Enviado a',
	'PM_USERS_REMOVED_NO_PM'=> 'Algunos usuarios no se pueden añadir porque tienen deshabilitada la bandeja de mensajes privados.',
	...
	'RULE_LIMIT_REACHED'	=> 'No se puede agregar más reglas de MP. Haz llegado al número máximo de reglas.',		
	...
	'UPLOAD_AVATAR_URL_EXPLAIN'	=> 'Introduce la URL del sitio que tiene la imagen, será copiada a este Foro.',
	...
	'USERNAME_TAKEN_USERNAME'	=> 'El nombre de usuario que introdujiste ya está en uso, por favor elije otro.',
	...
	'VIEW_SMILIES'			=> 'Mostrar emoticones como imágenes',
	...
	'WATCHED_EXPLAIN'	=> 'Debajo está la lista de foros y temas a los que estás suscrito. Serás notificado de nuevos mensajes en ellos. Para cancelar la suscripción marca el foro o tema y luego haz clic sobre el botón <em>No seguir marcados</em>.',
